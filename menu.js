...
const pizza = {
    ...
    popularity: 8.5,
    rating: 9,
    tags: ["Extra Cheesy", "Italian", "Mozzarella", "Vegetarian"]
}
...
const foodArr = [
    ...
    }, 
    {
        ...
        popularity: 8,
        rating: 9.5,
        tags: ["Too Cheesy", "Spicy", "Juicy", "Mouth-Watering"]
    },
    {
        name: "Doritos Fries",
        price: 4.5,
    ...
    },
    {
        ...
        popularity: 6,
        rating: 7.9,
        tags: ["Tangy", "Grilled", "Vegie", "Mouth-Watering"]
    },
    {
        name: "5 Cheese Pasta",
        price: 15,
        ...
        popularity: 10,
        rating: 9.8,
        tags: ["Cheesy", "Penne", "Spagetti", "Delicious"]
    }
]
...
const filteredFood = foodArr.filter(function(food){
    return (food.tags.includes("Juicy"))
...
function filterByProperty (property, number, type) {
    return foodArr.filter(function(food){
        return (type === 'above' && food[property] > number) || (type === 'below' && food[property] < number)
    })
