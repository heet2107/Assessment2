...
var newDeal = deals[0].title.replace('15% Off', "10% Off!")
...
var newDeal2 = deals[1].desc.replace('   This deal lasts until the end of March! ', "This deal lasts until the end of April!")
deals[1].desc = newDeal2
console.log(deals)